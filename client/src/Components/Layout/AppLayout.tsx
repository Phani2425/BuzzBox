            ...
            <div className='relative min-h-screen overflow-hidden bg-black'>
                ...
                <div className='h-[calc(100vh-4rem)] px-4 py-6'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-[1fr_2fr] lg:grid-cols-[1fr_2fr_1fr] gap-6 h-[calc(100%-2rem)] mt-8'>
                        ...
                        <div className={`fixed inset-y-0 left-0 transform ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'} md:hidden transition duration-200 ease-in-out z-40 w-64 bg-black/80 backdrop-blur-xl backdrop-saturate-150 overflow-y-auto`}>
                            <div className="p-6">
